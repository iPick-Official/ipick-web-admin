            ...
            <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 min-h-screen">
                ...
                >
                    <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div className="mt-2.5">
                                <input
                                    ...
                                    className="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-green-600"
                                />
                            </div>
                        </div>
                        ...
                        {/* Mobile Number */}
                        <div className="sm:col-span-2">
                            <label htmlFor="mobile-number" className="block text-sm font-semibold text-gray-900">
                                Mobile Number
                            </label>
                            <div className="mt-2.5 relative rounded-md shadow-sm">
                                ...
                                <input
                                    ...
                                    className="block w-full rounded-md bg-white pl-20 pr-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-green-600"
                                    pattern="[0-9]{10}"
                                    required
                                />
                            </div>
                            <p className="mt-1 text-sm text-gray-500">Enter 10-digit number without the leading 0.</p>
                        </div>

                        {/* ID Image Upload */}
                        <div className="sm:col-span-2">
                            <label htmlFor="id-image" className="block text-sm font-semibold text-gray-900">
                                Upload ID Image
                            </label>
                            <div className="mt-2.5">
                                <input
                                ...
                                <p className="mt-1 text-sm text-gray-500">Accepted formats: JPG, PNG, etc.</p>
                            </div>
                        </div>
