...
export default function Policies() {
    return (
        <Popover className="relative">
            ...
            >
                <div className="w-screen max-w-md flex-auto overflow-hidden rounded-3xl bg-white text-sm/6 shadow-lg ring-1 ring-gray-200">
                    <div className="p-4">
                        {policies.map((item) => (
                            <Link
                                key={item.name}
                                href={item.href}
                                className="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-100 transition"
                            >
