...
import Policies from './LandingPagePolicies';
        ...
        <header className="absolute inset-x-0 top-0 z-50">
            <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
                ...
                <div className="hidden lg:flex lg:gap-x-12">
                    ...
                    <a
                        href="/driver-center"
                        className="text-sm font-semibold hover:text-green-700 transition duration-300"
                    >
                        Driver Center
                    </a>
                    <a
            ...
            {isMobileMenuOpen && (
                <div className="lg:hidden fixed inset-0 z-50 bg-white dark:bg-zinc-900 p-6 overflow-y-auto">
                    ...
                    <div className="mt-6 flow-root">
                        <div className="-my-6 divide-y divide-gray-500/10">
                            <div className="space-y-2 py-6">
                                <Policies />
                                <a href="/driver-center" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold hover:bg-gray-50">Driver Center</a>
                                <a href="/help-center" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold hover:bg-gray-50">Help Center</a>
                            </div>
                            <div className="py-6">
